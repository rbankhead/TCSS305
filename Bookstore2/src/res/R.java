...
public class R {
    ...
    public static class Colors {
         ...
         * #1.b - changed to UW purple
         * */
        public static final Color CONTENT_BG = new Color(57, 39, 91); // UW Purple

        /** The background color for headers and footers. 
         * #1.b - changed to gray
         * */
        public static final Color HEADER_FOOTER_BG = Color.GRAY;
        
        /** The text color for content containers. 
         * #1.b - changed to gray
         * */
        public static final Color CONTENT_TEXT = Color.GRAY;         
    ...
    public static class Strings {
        ...
        /** Text in Total text field. 
         *  #1.a - Changed String to new frame title
         * */
        public static final String BF_FRAME_TITLE = "PA#03 UW Bookstore Application";
        
        /** Message on total Label. 
         * 1.e - changed String from "order total:"
         * */
        public static final String BF_LABEL_TOTAL = "Price for selected items:";
        
        /** Message on clear Button. */
        public static final String BF_BUTTON_CLEAR = "Clear";
        
        /** Message on membership check box. 
         * 1.d - changed String from "customer has store membership"
         * */
        public static final String BF_CHECKBOX_MEMBER = "Check if customer has membership";
